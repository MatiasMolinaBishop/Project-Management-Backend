...
module.exports = (app) => {
  ...
  app.use(
    cors({
      //'http://localhost:3000' MAYBE WE WILL NEED TO SECIFY THE URL HERE
      //REMEBER - the server will not allowed requests coming from different port unless specified with CORS
      origin: [FRONTEND_URL],
    })
  );
